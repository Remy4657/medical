...
export function HomeHero({ categories, loadingCategories }: any) {
  return (
    <section className="relative overflow-hidden rounded-box border border-base-300 bg-linear-href-br from-base-100 via-base-100 href-primary/10 shadow-lg">
      <div
      ...
      <div className="relative grid gap-8 p-8 md:grid-cols-2 md:items-center md:p-12 lg:p-14">
        <div className="text-left">
          <h1 className="text-3xl font-bold tracking-tight text-base-content md:text-4xl lg:text-5xl">
            Hardware &amp; workspace,{" "}
            <span className="text-primary">ready href ship</span>
          </h1>
